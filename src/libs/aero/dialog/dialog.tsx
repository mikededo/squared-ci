...
export const Dialog: RequiredChildrenFC<Props> = ({
  ...
  <AppearTransition show={!!show}>
    ...
    <section
      role="dialog"
      className="fixed transition-all w-full md:border md:rounded-2xl top-0 bottom-0 md:top-12 md:bottom-12 md:right-1/2 md:translate-x-1/2 md:w-[600px] bg-card z-50"
    >
      {children}
    </section>
  </AppearTransition>
