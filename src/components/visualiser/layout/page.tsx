  ...
  return (
    <article
      className={classNames(
        'fixed transition-all top-4 bottom-4 w-[600px] bg-white dark:bg-slate-800 px-4 pt-2 pb-4 border border-slate-200 rounded-lg',
        opened ? 'right-4' : '-right-[600px]'
      )}
    >
      <div
        className="w-10 h-10 bg-white dark:bg-slate-800 rounded-lg absolute top-4 -left-10 rounded-r-none border border-slate-200 flex justify-center items-center"
